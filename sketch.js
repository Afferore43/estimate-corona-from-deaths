...
class Graph {
    ...
    showStats() {
        ...
        if(this.showEstimated) {
            ...
            fill(51);
            textSize(8);
            text("using doubling time = " + nfc(this.doublingTime,1) + " days, fatality rate = " + nfc(this.fatalatyRate, 1) * 100 + " %, time between infection and death = " + nfc(this.infectionToDeath,0) + " days", 
                 this.pos.x + 10, 
                 this.pos.y + 116);
        }
